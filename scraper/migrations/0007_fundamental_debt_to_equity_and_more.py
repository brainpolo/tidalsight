    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assets', models.ManyToManyField(blank=True, related_name='hn_posts', to='scraper.asset')),
            ],
            options={
                'ordering': ['-posted_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_at', models.DateTimeField()),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='scraper.hnpost')),
            ],
            options={
                'ordering': ['-posted_at'],
            },
