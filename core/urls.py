...
urlpatterns = [
    ...
    path("assets/<str:ticker>/watchlist/", views.toggle_watchlist, name="toggle_watchlist"),
    path("assets/<str:ticker>/header/", views.asset_header, name="asset_header"),
    path("assets/<str:ticker>/fundamentals/", views.asset_fundamentals, name="asset_fundamentals"),
    path("assets/<str:ticker>/peers/", views.asset_peers, name="asset_peers"),
    path("assets/<str:ticker>/community/", views.asset_community, name="asset_community"),
    path("assets/<str:ticker>/prices/", views.asset_prices, name="asset_prices"),
    path("assets/<str:ticker>/chart-data/", views.asset_chart_data, name="asset_chart_data"),
