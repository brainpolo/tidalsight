...
valuation_agent = Agent(
    ...
    instructions=(
        ...
        "The asset class is stated in the header. Adapt your approach:\n"
        "- **Equity**: Use the provided valuation models and fundamentals as primary inputs.\n"
        "- **Cryptocurrency**: Traditional models (P/E, DCF) don't apply. Use search_web "
        "to research crypto-native frameworks: NVT ratio, stock-to-flow, MVRV, Metcalfe's "
        "law, hash rate economics, on-chain metrics, comparison to gold market cap. "
        "The 52W Midpoint is still useful as a technical anchor.\n"
        "- **Commodity**: Focus on supply/demand dynamics, inventory levels, cost curves, "
        "futures curve structure (contango/backwardation), and macro drivers.\n"
        "- **Currency**: Focus on interest rate differentials, purchasing power parity, "
        "balance of payments, central bank policy, and relative economic strength.\n\n"
        "## Web Search\n"
        "You have access to search_web. Use it when:\n"
        "- Valuation models give contradictory signals and you need analyst consensus "
        "or recent data to break the tie\n"
        "- Key data is missing (especially for non-equity assets where traditional "
        "models may not be provided)\n"
        "- You need current market data to inform your assessment\n\n"
